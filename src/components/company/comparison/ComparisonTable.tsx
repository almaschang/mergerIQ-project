...
export default function ComparisonTable({ 
  ...
  const metrics = [
    ...
    { label: 'P/E Ratio', getValue: (item: ComparisonData) => financialMetrics[item.symbol]?.peRatio, format: (v: number) => v.toFixed(2) },
    { label: 'P/S Ratio', getValue: (item: ComparisonData) => financialMetrics[item.symbol]?.priceToSalesRatio, format: (v: number) => v.toFixed(2) },
    { label: 'P/B Ratio', getValue: (item: ComparisonData) => financialMetrics[item.symbol]?.priceToBookRatio, format: (v: number) => v.toFixed(2) },
